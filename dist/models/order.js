...
var orderStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw Error("error in getting orders from database - ".concat(error_1));
    ...
    orderStore.prototype.create = function (s) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [s.user_id, s.order_status])];
                    case 2:
                        result = _a.sent();
                        order = result.rows[0];
                        conn.release();
    ...
    orderStore.prototype.getCurrentOrderByUser = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not find class ".concat(id, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    orderStore.prototype.addToCart = function (p) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [p.order_id, p.product_id, p.quantity])];
                    case 2:
                        result = _a.sent();
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Could not add new product to order. Error: ".concat(err_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
