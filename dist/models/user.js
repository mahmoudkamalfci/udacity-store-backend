...
var userStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_1 = _a.sent();
                        throw Error("error in getting users from database - ".concat(error_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not find class ".concat(id, ". Error: ").concat(err_1));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    userStore.prototype.create = function (s) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, hash, result, user, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        conn = _a.sent();
                        hash = bcrypt_1["default"].hashSync(s.password + (BCRYPT_PASSWORD === null || BCRYPT_PASSWORD === void 0 ? void 0 : BCRYPT_PASSWORD.trim()), Number(SALT_ROUNDS));
                        return [4 /*yield*/, conn.query(sql, [s.firstname, s.lastname, hash])];
                    case 2:
                        result = _a.sent();
                        user = result.rows[0];
                        conn.release();
    ...
    userStore.prototype.authenticate = function (firstname, lastname, password) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, user, validPassword, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 2:
                        ...
                        if (result.rows.length) {
                            user = result.rows[0];
                            validPassword = bcrypt_1["default"].compareSync(password + BCRYPT_PASSWORD, user.password);
                            if (validPassword) {
                                return [2 /*return*/, user];
                            }
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw Error("error in getting user from database - ".concat(error_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
